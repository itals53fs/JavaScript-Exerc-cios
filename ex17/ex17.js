(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'Tales Félix'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, 'serano'))
    ...
    */
    ...
    text = text.replace(/O Centauro de Luvas/, (captura)=>{
